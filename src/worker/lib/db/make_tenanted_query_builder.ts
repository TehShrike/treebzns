...
export type TenantedQueryBuilder = {
	...
	get_raw_rows: (query: SafeSqlQuery) => Promise<unknown[][]>
}

const make_tenanted_query_builder = ({ company_id, mysql }: { company_id: bigint, mysql: MysqlHelpersObject }): TenantedQueryBuilder => {
...
export default make_tenanted_query_builder
