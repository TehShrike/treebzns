...
type SessionUser = {
	employee: Omit<AutogeneratedEmployee, typeof schema.employee.password_hash | typeof schema.employee.number_of_password_hash_iterations>
	company: Omit<AutogeneratedCompany, typeof schema.company.logo>
}
...
// TODO: why are the query result types here { employee_id: AutogeneratedEmployee, company_id: AutogeneratedEmployee } instead of being the correct column types of bigint?
