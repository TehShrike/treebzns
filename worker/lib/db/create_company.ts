...
type CreateCompanyArg = Omit<AutogeneratedInsertableCompany, 'default_initial_project_document_id'>

type OwnerEmployeeArg = Omit<AutogeneratedInsertableEmployee, 'company_id' | 'is_owner' | 'password_hash' | 'number_of_password_hash_iterations'> & { password: string }
