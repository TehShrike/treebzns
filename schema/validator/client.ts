...
export const validator_object = {
	...
	billing_client_address_id: jv.is_bigint,
	primary_phone: jv.nullable(jv.is_string),
	primary_email: jv.nullable(jv.is_string),
	tax_rate_id: jv.nullable(jv.is_bigint),
	notes: jv.nullable(jv.is_string),
	referred_by: jv.nullable(jv.is_string),
