...
CREATE TABLE `client` (
  ...
  `default_project_address_id` int unsigned NOT NULL,
  `billing_name` varchar(500) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `billing_address_line_1` varchar(500) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `billing_address_line_2` varchar(500) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `billing_city` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `billing_state` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `billing_zip` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
